...
let shapes = {
    oval: (color: Color) => <ellipse cx="50%" cy="50%" rx="30" ry="49" fill={color} stroke={color} />,
    round: (color: Color) => <circle cx="50%" cy="50%" r="49" fill={color} stroke={color}  />,
    triangle: (color: Color) => <polygon points="50,0 0,100 100,100" fill={color} stroke={color} />,
